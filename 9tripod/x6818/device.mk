...
################################################################################
PRODUCT_COPY_FILES += \
	device/9tripod/x6818/boot/logo.bmp:boot/logo.bmp \
	device/9tripod/x6818/boot/battery.bmp:boot/battery.bmp \
	device/9tripod/x6818/boot/update.bmp:boot/update.bmp \
	device/9tripod/x6818/boot/debug-ramdisk.img:boot/debug-ramdisk.img

################################################################################
# busybox
################################################################################
PRODUCT_COPY_FILES += \
	device/9tripod/x6818/busybox:system/bin/busybox

################################################################################
# init
################################################################################
PRODUCT_COPY_FILES += \
	device/9tripod/x6818/init.x6818.rc:root/init.x6818.rc \
	device/9tripod/x6818/init.x6818.usb.rc:root/init.x6818.usb.rc \
	device/9tripod/x6818/init.recovery.x6818.rc:root/init.recovery.x6818.rc \
	device/9tripod/x6818/fstab.x6818:root/fstab.x6818 \
	device/9tripod/x6818/ueventd.x6818.rc:root/ueventd.x6818.rc

################################################################################
# key
################################################################################
PRODUCT_COPY_FILES += \
	device/9tripod/x6818/keypad_x6818.kl:system/usr/keylayout/keypad_x6818.kl \
	device/9tripod/x6818/keypad_x6818.kcm:system/usr/keychars/keypad_x6818.kcm \
	device/9tripod/x6818/nxp_ir_recv.kl:system/usr/keylayout/nxp_ir_recv.kl

################################################################################
# touch
################################################################################
PRODUCT_COPY_FILES += \
    device/9tripod/x6818/gslX680.idc:system/usr/idc/gslX680.idc \
    device/9tripod/x6818/Goodix-TS.idc:system/usr/idc/Goodix-TS.idc
...
################################################################################
#PRODUCT_COPY_FILES += \
	#device/9tripod/x6818/vold.fstab:system/etc/vold.fstab
...
# mixer paths
PRODUCT_COPY_FILES += \
	device/9tripod/x6818/audio/tiny_hw.x6818.xml:system/etc/tiny_hw.x6818.xml
# audio policy configuration
PRODUCT_COPY_FILES += \
	device/9tripod/x6818/audio/audio_policy.conf:system/etc/audio_policy.conf

################################################################################
# media, camera
################################################################################
PRODUCT_COPY_FILES += \
	device/9tripod/x6818/media_codecs.xml:system/etc/media_codecs.xml \
	device/9tripod/x6818/media_profiles.xml:system/etc/media_profiles.xml
...
# 3G & 4G
PRODUCT_COPY_FILES += \
	device/9tripod/x6818/pppd:system/bin/pppd
...
################################################################################
PRODUCT_COPY_FILES += \
	device/9tripod/x6818/tablet_core_hardware.xml:system/etc/permissions/tablet_core_hardware.xml \
...
PRODUCT_AAPT_CONFIG := xlarge hdpi xhdpi large normal ldpi mdpi xxhdpi nodpi
PRODUCT_AAPT_PREF_CONFIG := xhdpi

PRODUCT_CHARACTERISTICS := tablet,usbstorage

DEVICE_PACKAGE_OVERLAYS := \
	device/9tripod/x6818/overlay
...
# buletooth
PRODUCT_COPY_FILES += \
	hardware/samsung_slsi/slsiap/prebuilt/modules/rtk_btusb.ko:system/lib/modules/rtk_btusb.ko
...
# 9tripod Application
$(call inherit-product-if-exists, vendor/9tripod/apps/nxapps.mk)
$(call inherit-product-if-exists, vendor/9tripod/apps/smartsync.mk)
